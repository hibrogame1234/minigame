...
const prizes = [
    { text: "2000 GOLD", color: "#FF1493", chance: 2 },
    { text: "50 Mảnh B2", color: "#4B0082", chance: 17 },
    { text: "1000 GOLD", color: "#FFD700", chance: 6 },
    { text: "300 GOLD", color: "#00FF7F", chance: 17 },
    { text: "1500 GOLD", color: "#FF4500", chance: 4 },
    { text: "500K NGỌC", color: "#1E90FF", chance: 15 },
    { text: "1.5M NGỌC", color: "#FFB6C1", chance: 9 },
    ...
    spinBtn.addEventListener('click', function() {
        ...
        window.dbOnValue(window.dbRef(window.db, 'wheelHistory'), (snapshot) => {
            ...
            if (hasPlayed) {
                ...
                startSpinAction(name); // Gọi hàm quay
            }
        }, { onlyOnce: true });
    });
}

// HÀM QUAY - PHẦN BẠN BỊ THIẾU
...
if (confirmResetBtn) {
    confirmResetBtn.addEventListener('click', () => {
        if (confirm("Reset toàn bộ lịch sử?")) {
